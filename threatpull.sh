...
echo "# Generated: `date`" > /home/caveman/downloads/emerging_threats_shadowserver_ips.txt

cat /tmp/emerging-Block-IPs.txt | sed -e '1,/# \Shadowserver C&C List/d' -e '/#/,$d' | 
sed -n '/^[0-9]/p' | sed 's/$/ Shadowserver IP/' >> 
/home/caveman/downloads/emerging_threats_shadowserver_ips.txt

echo "# Generated: `date`" > /home/caveman/downloads/emerging_threats_spamhaus_drop_ips.txt

cat /tmp/emerging-Block-IPs.txt | sed -e '1,/#Spamhaus DROP Nets/d' -e '/#/,$d' | xargs 
-n 1 prips | sed -n '/^[0-9]/p' | sed 's/$/ Spamhaus IP/' >> 
/home/caveman/downloads/emerging_threats_spamhaus_drop_ips.txt

echo "# Generated: `date`" > /home/caveman/downloads/emerging_threats_dshield_ips.txt

cat /tmp/emerging-Block-IPs.txt | sed -e '1,/#Dshield Top Attackers/d' -e '/#/,$d' | 
xargs -n 1 prips | sed -n '/^[0-9]/p' | sed 's/$/ Dshield IP/' >> 
/home/caveman/downloads/emerging_threats_dshield_ips.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/emerging_threats_compromised_ips.txt

cat /tmp/compromised-ips.txt | sed -n '/^[0-9]/p' | sed 's/$/ Compromised IP/' >> 
/home/caveman/downloads/emerging_threats_compromised_ips.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/binary_defense_ban_list.txt

cat /tmp/binary_defense_ips.txt | sed -n '/^[0-9]/p' | sed 's/$/ Binary Defense IP/' >> 
/home/caveman/downloads/binary_defense_ban_list.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/av_ip_rep_list.txt

cat /tmp/reputation.snort | sed -n '/^[0-9]/p' | sed "s/# //">> 
/home/caveman/downloads/av_ip_rep_list.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/sslipblacklist.txt

cat /tmp/sslipblacklist.csv | sed -n '/^[0-9]/p' | cut -d',' -f1,3 | sed "s/,/ /" | sed 
's/$/ SSLBL IP/' >> /home/caveman/downloads/sslipblacklist.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/zeus_ip_block_list.txt

cat /tmp/zeustracker.txt | sed -n '/^[0-9]/p' | sed 's/$/ Zeus IP/' >> 
/home/caveman/downloads/zeus_ip_block_list.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/spyeye_ip_block_list.txt

cat /tmp/spyeyetracker.txt | sed -n '/^[0-9]/p' | sed 's/$/ Spyeye IP/' >> 
/home/caveman/downloads/spyeye_ip_block_list.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/palevo_ip_block_list.txt

cat /tmp/palevotracker.txt | sed -n '/^[0-9]/p' | sed 's/$/ Palevo IP/' >> 
/home/caveman/downloads/palevo_ip_block_list.txt
...
echo "# Generated: `date`" > /home/caveman/downloads/malc0de_black_list.txt

cat /tmp/IP_Blacklist.txt | sed -n '/^[0-9]/p' | sed 's/$/ Malc0de IP/' >> 
/home/caveman/downloads/malc0de_black_list.txt
